...
def get_airtable_data(table_name):
    # Fetching using Grid view to respect your manual sorting in Airtable
...
@app.route('/')
def index():
    # 1. Settings (Pulling from your horizontal 1-row table)
    ...
    for i, r in enumerate(signup_recs):
        ...
        # Match user by Player Code (ensuring both are strings)
...
def signup():
    ...
    # Adding Date column support for your Signups table
    data = {"fields": {
...
# Keep existing /validate, /cancel, and /logout routes as they were...
